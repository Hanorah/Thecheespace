		...
		<section className="w-full bg-marquee padding-y rounded-t-[20px]">
			...
			<div className="w-full padding-x py-[20px]">
				<div className="w-[50%] sm:w-full xm:w-full">
					<h3 className="paragraph font-medium text-white font-NeueMontreal ml-5 mt-5 mb-5">
						What you can expect?
					</h3>
				</div>
				<div className="w-full flex  sm:flex-col xm:flex-col sm:gap-[20px] xm:gap-[20px]">

					<div className="w-[100%] sm:w-full xm:w-full flex flex-wrap gap-[20px]">
